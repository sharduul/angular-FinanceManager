...
StaticServlet.prototype.handleRequest = function(req, res) {
  ...
  if (parts[parts.length-1].charAt(0) === '.')
	...
	if (req.method === 'POST') {
		...
		console.log("in GET........");
		return self.findAndSendTarget(req, path, res, self);
